...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    """Clean the tweets dataset: keep text/date, drop retweets, nulls, duplicates and empty strings."""
    try:
        ...
        logger.debug('Data preprocessing completed: retweets, missing values, duplicates, and empty strings removed.')
        return df
